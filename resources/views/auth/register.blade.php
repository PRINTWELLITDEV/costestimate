...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white h5">{{ __('Register to '.config('app.name')) }}</div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 d-flex gap-3">
                                @foreach ($sites as $site)
                                    <input type="radio" id="site-{{ $site->site }}" class="site-radio" name="site" value="{{ $site->site }}">
                                    <label for="site-{{ $site->site }}" class="site-label">
                                        <img src="{{ asset($site->logo_pic_url) }}" alt="{{ $site->site_desc }}">
                                        <div class="small mt-1 text-center">{{ $site->site_desc }}</div>
                                    </label>
                                @endforeach
                            </div>
                        </div>
